...
2. Escolha PIX como m�todo de pagamento
3. Voc� ser� redirecionado para o Mercado Pago (sandbox)
4. Use as credenciais de teste do MP

## Obter Credenciais de Teste

1. Acesse: https://www.mercadopago.com.br/developers/panel/app
2. Clique em "Suas aplica��es" > "Criar aplica��o"
3. V� em "Credenciais" > "Credenciais de teste"
4. Copie:
   - Access Token (come�a com TEST-)
   - Public Key (come�a com TEST-)

## Pr�ximos Passos

- Configure webhooks (necess�rio dom�nio p�blico ou ngrok)
